...
export const backgroundCategories: BackgroundCategory = {
  ...
  /**
   * Empty on desktop. These eleven PNGs only ever existed in the R2 bucket —
   * there is no copy in public/, so they were already broken whenever the
   * dashboard ran without R2 configured. Listing them here would render eleven
   * broken tiles in the picker.
   *
   * To restore: drop demo-1.png … demo-11.png into public/demo/ and put the
   * paths back.
   */
  demo: [],
  paper: [
