...
import { z } from "zod";
import { generateDemo } from "../demo/sidebar/agent/generate";
...
// Previously this file carried its own copy of generateDemo and the whole SSE
// reader. Two copies meant every change to the transport had to be made twice,
// and one of them was already drifting. There is now a single implementation.

// The SseEventData and SseHandlers interfaces used to be duplicated here for
// that local copy. The shared implementation carries its own from @/types.
